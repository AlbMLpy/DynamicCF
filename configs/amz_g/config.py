...
dataset = DIR_AMZ_G_NAME
prepared_data_path = DATA_DIR_AMZ_G / 'prepared_data.csv'
init_ratio = 0.7
quantile_train = 0.99
...
hyperparams_dir = RESULTS_DIR / DIR_AMZ_G_NAME / 'hyperparams'
metric_dynamics_dir = RESULTS_DIR / DIR_AMZ_G_NAME / 'metric_dynamics'
graphics_dir = RESULTS_DIR / DIR_AMZ_G_NAME / 'graphics'
ablation_study_dir = RESULTS_DIR / DIR_AMZ_G_NAME / 'ablation_study'
