...
dataset = DIR_ML20M_NAME
prepared_data_path = DATA_DIR_ML20M / 'prepared_data.csv'
init_ratio = 0.4
quantile_train = 0.99
hm_actions_min_stream = None
how_many_iterations = 200
...
hyperparams_dir = RESULTS_DIR / DIR_ML20M_NAME / 'hyperparams'
metric_dynamics_dir = RESULTS_DIR / DIR_ML20M_NAME / 'metric_dynamics'
graphics_dir = RESULTS_DIR / DIR_ML20M_NAME / 'graphics'
ablation_study_dir = RESULTS_DIR / DIR_ML20M_NAME / 'ablation_study'
